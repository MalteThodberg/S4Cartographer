...
Now the graph has grown substantially! `IRanges` defines a large number of specialized sub-classes from the building blocks in `S4Vectors`. We can also see how `GenomicRanges` S4 classes depends on `IRanges` first and then `S4Vectors`.
